...
<div class="personal-perjawatan-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            'idTarafPerjawatan.taraf_perjawatan',
            'idSkimPerjawatan.nama_skim_perjawatan',
            //'id_ref_taraf_perjawatan',
            'nama_perjawatan',
            //'id_ref_skim_perjawatan',
            //'id_ref_gred_perjawatan',
            'idGredPerjawatan.gred_perjawatan',
            //'id_agensi_institut',
            'idAgensiInstitut.nama_institut',
            'nama_institut_lain',
            'nama_bidang_lain',
            'no_telefon_pejabat',
            'id_ref_purata_jam_mengajar',
            'idPurataJamMengajar.purata_jam_mengajar',
