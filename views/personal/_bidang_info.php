...
<div class="personal-bidang-index">
    ...
    <p>
        ...
        <?php //= Html::button('Tambah Bidang', ['value' => Url::to(['personal-bidang/create', 'id' => $id_personal]), 'class' => 'btn btn-success', 'id' => 'tambah-bidang']) ?>
    </p>
            ...
            [
                ...
                'checkboxOptions' => function ($model, $key, $index, $column) {
                    return $model->is_aktif? 
                        ['checked' => true, 'class' => 'bidang-aktif-check', 'disabled' => true, 'value' => Url::to(['personal-bidang/bidang-update-active', 
                         'id' => $model->id_personal_bidang, 'id_personal' => $model->id_personal])]
                        : 
                        ['checked' => false, 'class' => 'bidang-aktif-check', 'disabled' => true, 'value' => Url::to(['personal-bidang/bidang-update-active', 
                         'id' => $model->id_personal_bidang, 'id_personal' => $model->id_personal])];
                }
